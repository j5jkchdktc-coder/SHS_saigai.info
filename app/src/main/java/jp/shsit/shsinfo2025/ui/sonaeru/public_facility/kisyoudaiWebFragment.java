...
public class kisyoudaiWebFragment extends Fragment {

    String pdf;
    public kisyoudaiWebFragment(String pdf){
        this.pdf=pdf;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.kisyoudai_web, container, false);

        ((PDFView)view.findViewById(R.id.pdfView)).fromAsset(this.pdf).load();
