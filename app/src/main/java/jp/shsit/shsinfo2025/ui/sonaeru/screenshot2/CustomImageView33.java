...
public class CustomImageView33 extends AppCompatImageView {
    ...
    public CustomImageView33(Context context) {
        super(context);
    }

    public CustomImageView33(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomImageView33(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        // ファイル名
        String fileName = String.format("CameraIntent7.jpg");
