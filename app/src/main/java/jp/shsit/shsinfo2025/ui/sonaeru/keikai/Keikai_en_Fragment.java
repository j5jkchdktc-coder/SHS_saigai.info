...
public class Keikai_en_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
     ...
     //   Bitmap bmp = BitmapFactory.decodeResource(r,R.drawable.base2);
        ...
        img1.setImageResource(R.drawable.base3_en);
      ...
      //  Log.i("item", "高さ = " + lp.topMargin+","+bmp.getHeight()+","+bmp.getWidth());
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        if (xxx > 200 && xxx < 487 && yy > 256 && yy < 522) {
                            img1.setImageResource(R.drawable.lv5en);
                            audioStop();
                            audioPlay("lv5");
                        } else if (xxx > 200 && xxx < 531 && yy > 532 && yy < 720) {
                            img1.setImageResource(R.drawable.lv4en);
                            audioStop();
                            audioPlay("lv4");
                        } else if (xxx > 200 && xxx < 568 && yy > 800 && yy < 970) {
                            img1.setImageResource(R.drawable.lv3en);
                            audioStop();
                            audioPlay("lv3");
                        } else if (xxx > 200 && xxx < 605 && yy > 1010 && yy < 1215) {
                            img1.setImageResource(R.drawable.lv2en);
                            audioStop();
                            audioPlay("lv2");
                        } else if (xxx > 200 && xxx < 645 && yy > 1258 && yy < 1500) {
                            img1.setImageResource(R.drawable.lv1en);
                            audioStop();
                            audioPlay("lv1");
        ...
        String language = PreferenceManager.getDefaultSharedPreferences(requireActivity()).getString("lang", "English");

        if(language.equals("Vietnamese")){
            modBtn.setText("Quay lại");
        ...
        keikaiBtn.setText("Disaster Management in Japan");
    ...
    private boolean audioSetup(String level) {
        ...
        if (level.equals("lv1")) {
            Log.i("test", "koko");
            mediaPlayer = MediaPlayer.create(getContext(), R.raw.lev1en);
        } else if (level.equals("lv2")) {
            mediaPlayer = MediaPlayer.create(getContext(), R.raw.lev2en);
        } else if (level.equals("lv3")) {
            mediaPlayer = MediaPlayer.create(getContext(), R.raw.lev3en);
        } else if (level.equals("lv4")) {
            mediaPlayer = MediaPlayer.create(getContext(), R.raw.lev4en);
        } else if (level.equals("lv5")) {
            mediaPlayer = MediaPlayer.create(getContext(), R.raw.lev5en);
        }
