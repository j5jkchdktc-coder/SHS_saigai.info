...
public class CustomImageView6 extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public CustomImageView6(Context context) {
        super(context);
        init(context);

    }

    public CustomImageView6(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomImageView6(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        if(name.equals("English")){
            setImageResource(R.drawable.use_kikikuru_eng);
        }else{
            setImageResource(R.drawable.use_kikikuru_jap);
        }
