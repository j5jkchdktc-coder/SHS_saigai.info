...
public class CustomImageView22 extends AppCompatImageView {
    ...
    public CustomImageView22(Context context) {
        super(context);
    }

    public CustomImageView22(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomImageView22(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        Log.d("test","path: " + String.valueOf(cFolder));
        // ファイル名
        String fileName = String.format("CameraIntent6.jpg");
        ...
        //setImageResource(R.drawable.ns_hijyou1);
