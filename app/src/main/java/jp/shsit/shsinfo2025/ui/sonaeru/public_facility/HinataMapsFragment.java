...
public class HinataMapsFragment extends Fragment implements LatLongCatch.OnLocationResultListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.hinata_map, container, false);
...
//　基本
    ...
    public void AED_CsvReader(){
        ...
        String result = "";
        try {
            InputStream inputStream = getResources().getAssets().open("hinata3.csv");
    ...
    public void onLocationResult(LocationResult locationResult) {
        ...
        Double dis = distance(31.828812,131.446593,lat,lng);
        Log.i("test",dis+"desu");
        //地図の表示位置
        //現在地周辺

        if(dis>=1300){//公園外なら 武道館 1300m以上
            GeoPoint centerPoint = new GeoPoint(31.828812,131.446593);
