...
public class CustomImageView3 extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private void init(Context context) {
        ...
        if(name.equals("English")){
            setImageResource(R.drawable.ar7);
        }else{
            setImageResource(R.drawable.ar5);
        }
        //setImageResource(R.drawable.tukaikata2);
