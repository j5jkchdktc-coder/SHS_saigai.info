...
public class Keikai_child_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
     ...
     //   Bitmap bmp = BitmapFactory.decodeResource(r,R.drawable.base2);
        ...
        img1.setImageResource(R.drawable.base_child_wild);
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        if (xxx > 200 && xxx < 487 && yy > 256 && yy < 522) {
                            img1.setImageResource(R.drawable.lv_child_wild5);
                            audioStop();
                            audioPlay("lv5");
                        } else if (xxx > 200 && xxx < 531 && yy > 532 && yy < 720) {
                            img1.setImageResource(R.drawable.lv_child_wild4);
                            audioStop();
                            audioPlay("lv4");
                        } else if (xxx > 200 && xxx < 568 && yy > 800 && yy < 970) {
                            img1.setImageResource(R.drawable.lv_child_wild3);
                            audioStop();
                            audioPlay("lv3");
                        } else if (xxx > 200 && xxx < 605 && yy > 1010 && yy < 1215) {
                            img1.setImageResource(R.drawable.lv_child_wild2);
                            audioStop();
                            audioPlay("lv2");
                        } else if (xxx > 200 && xxx < 645 && yy > 1258 && yy < 1500) {
                            img1.setImageResource(R.drawable.lv_child_wild1);
                            audioStop();
                            audioPlay("lv1");
