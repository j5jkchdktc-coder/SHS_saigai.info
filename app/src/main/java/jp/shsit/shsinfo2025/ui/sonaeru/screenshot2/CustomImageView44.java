...
public class CustomImageView44 extends AppCompatImageView {
    ...
    public CustomImageView44(Context context) {
        super(context);
    }

    public CustomImageView44(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomImageView44(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        // ファイル名
        String fileName = String.format("CameraIntent8.jpg");
