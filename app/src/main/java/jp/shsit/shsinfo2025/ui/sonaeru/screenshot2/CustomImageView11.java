package jp.shsit.shsinfo2025.ui.sonaeru.screenshot2;
...
public class CustomImageView11 extends  AppCompatImageView {
    ...
    public CustomImageView11(Context context) {
        super(context);
    }

    public CustomImageView11(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        width1=dispMet.xdpi;
        Log.i("test",dispMet.xdpi+","+dispMet.ydpi);

        init(context);

    }

    public CustomImageView11(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        // ファイル名
        String fileName = String.format("CameraIntent5.jpg");
        File cameraFile = new File(file, fileName);
        try(InputStream inputStream0 = new FileInputStream(cameraFile) ) {
      ...
      /*  float width2 = (float) (width1/getImageWidth());
        ...
        invalidate();
        Log.i("test",width1+","+width2+","+getImageWidth());
    ...
    private ScaleGestureDetector.SimpleOnScaleGestureListener simpleOnScaleGestureListener = new ScaleGestureDetector.SimpleOnScaleGestureListener() {
        ...
        public void onScaleEnd(ScaleGestureDetector detector) {
            ...
            float focusX1 = detector.getFocusX();
            float focusY2 = detector.getFocusY();
            Log.i("test",focusX1+","+focusY2+"です　終わり");
        }
    ...
    private float getImageWidth(){
        float result;
        try{
            result = (getDrawable().getIntrinsicWidth())*getMatrixValue(Matrix.MSCALE_X);
        }catch (Exception e){
            result = 100.0f;
        }
    ...
    private float getImageHeight(){
        float result;
        try{
            result =  (getDrawable().getIntrinsicHeight())*getMatrixValue(Matrix.MSCALE_Y);
        }catch (Exception e){
            result = 100.0f;
        }
        return result;
