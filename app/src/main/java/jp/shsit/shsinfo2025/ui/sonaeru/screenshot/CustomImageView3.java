...
public class CustomImageView3 extends AppCompatImageView {
    ...
    public CustomImageView3(Context context) {
        super(context);
    }

    public CustomImageView3(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomImageView3(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        // ファイル名
        String fileName = String.format("CameraIntent3.jpg");
